      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text('ID Сотрудника: #WMS-1102', style: AppTextStyles.caption.copyWith(color: AppColors.muted)),
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                  Icon(Icons.home_work_outlined, size: 14, color: AppColors.muted),
                  SizedBox(width: 6),
                  Text('Центральный склад СМП', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.muted)),
                ],
              ),
            ),
            ...
            _ProfileMenuItem(
              ...
              subtitle: 'База данных обновлена',
              icon: Icons.sync,
              iconColor: AppColors.primary,
              iconBgColor: AppColors.primarySoft,
              trailing: const Text('100%', style: TextStyle(color: Color(0xFF28A745), fontSize: 12, fontWeight: FontWeight.w800)),
              onTap: () {},
            ),
            const SizedBox(height: 12),
            _ProfileMenuItem(
              title: 'Настройки терминала сбора данных',
              icon: Icons.tune,
            ...
            const SizedBox(height: 12),
            _ProfileMenuItem(
              title: 'Связаться с диспетчерской',
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text('Выйти из терминала', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.red.shade700)),
                    ),
                  ],
                ),
              ),
